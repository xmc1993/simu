...
public class JoinInfo {
    ...
    public static class Builder<M> {
        ...
        private cn.superid.jpa.query.Query<M> query;

        public Builder(cn.superid.jpa.query.Query<M> query, JoinInfo joinInfo) {
            this.query = query;
            this.joinInfo = joinInfo;
        }

        public cn.superid.jpa.query.Query<M> endJoin() {
            return query;
        }
