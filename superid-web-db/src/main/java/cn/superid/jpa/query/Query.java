...
public class Query<M> {
    ...
    protected cn.superid.jpa.query.Expr condition = cn.superid.jpa.query.Expr.dummy();
    ...
    public Query<M> where(cn.superid.jpa.query.Expr expr) {
        this.condition = expr;
        return this;
    }
    ...
    public Query<M> not(cn.superid.jpa.query.Expr expr) {
    ...
    public Query<M> or(cn.superid.jpa.query.Expr... exprs) {
        if(exprs.length<1) {
            return this;
        }
        cn.superid.jpa.query.Expr curExpr = exprs[0];
...
//    }
    ...
    public Query<M> and(cn.superid.jpa.query.Expr expr) {
